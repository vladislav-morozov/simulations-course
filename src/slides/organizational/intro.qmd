...
format:
  revealjs:
    include-in-header: 
      text: |
        <meta name="description" content="Course introduction for fundamentals of Monte Carlo simulations in data science (lecture notes slides)."/> 
    width: 1150
    slide-number: true
    sc-sb-title: true
    incremental: true   
...
open-graph:
    description: "Course introduction for fundamentals of Monte Carlo simulations in data science (lecture notes slides)." 
---
...
Check out @Nikolov2022WritingTipsEconomics
 
:::

::: {.column width="29%"}

![](/images/book-covers/alley-2012.jpeg)

 
@Alley2013CraftScientificPresentations

:::

::: {.column width="33%"}

![](/images/book-covers/schimel-2013.jpg)


@Schimel2012WritingScienceHow
