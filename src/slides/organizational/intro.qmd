...
- What is the real coverage of a nominally 95% confidence interval? 
...
Simulations offer the next best thing: can check every aspect of performance in controlled "lab" setting

</div>


- Using synthetic data: can control every part of data generating process
- Synthetic data $\Rightarrow$ full knowledge of target quantities (esp. critical for causal methods)
