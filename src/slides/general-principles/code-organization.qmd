...
Notice the type hints for `dgp` and `estimator`
...
Protocols communicate information about interfaces both to readers and type checkers — a <span class="highlight">contract</span>
