...
subtitle: "Data Classes for Scenarios. Running Many Simulations"
author: Vladislav Morozov  
format:
  revealjs:
    include-in-header: 
      text: |
        <meta name="description" content="How to write good Monte Carlo simulation code in data science: orchestrating execution of many simulation scenarios; data classes (lecture note slides)"/> 
    width: 1150
    slide-number: true
    sc-sb-title: true
    incremental: true   
...
open-graph:
    description: "How to write good Monte Carlo simulation code in data science: orchestrating execution of many simulation scenarios; data classes (lecture note slides)" 
---
...
- Chapter 39 in @Lutz2025LearningPythonPowerful on decorators
- Chapter 6 in @Lau2023LearningDataScience for a refresher on pandas
:::
...
Can talk about further improvements, handling results, but we have an <span class="highlight">extensible and broadly-applicable</span> core
