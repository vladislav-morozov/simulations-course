...
- Can create manually: a file that creates desired instances and packs them somehow
- Can make automatically (e.g. as a Cartesian product of list of DGPs, sample sizes, estimators)

Depends on your goal: whether you want all possible combinations (beware of exponential growth) or some specific ones (beware of missing a desired combination)
...
We want all possible combinations — simplest approach is then to follow a suitable Cartesian product and automate generating a list of scenarios.

#### Resulting File and File Structure
