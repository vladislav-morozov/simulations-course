...
Can talk about further improvements, handling results, but we've got a <span class="highlight">extensible and broadly-applicable</span> core
...
Quite typical — export whole raw simulation results, particularly in simulations where individual runs are expensive

Can export as a CSV without adding to `SimulationOrchestrator`

Or could add a `results` fields to `Orchestrator`
