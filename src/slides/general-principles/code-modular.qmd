...
## Extending Our Code {background="#00100F"}
 
  
### Summarizing Results {background="#43464B"}
...
Scope changes are natural, especially in research
...
(or interfaces in languages that support them)
