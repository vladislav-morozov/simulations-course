...
```{python}
#| echo: true
def simulate_static_ols(n_sim=1000, n_obs=100, beta0=0, beta1=0.5):
    ...
    for _ in range(n_sim):
        ...
        # 3. Compute error
        results_ols_errors.append(beta_hat[1]-beta1)  # Store slope estimate
...
```{python}
#| echo: true
static_results = simulate_static_ols()
...
def run_ols_simulation(n_sim=1000, n_obs=100, beta0=0, beta1=0.5, rho=0, dgp_type="strict"):
    """
