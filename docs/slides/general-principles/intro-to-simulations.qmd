---
title: "Why Monte Carlo? General Principles"
...
format:
  revealjs:
    include-in-header: 
      text: |
        <meta name="description" content="A high-level overview of the place of Monte Carlo simulations. Introduction to best practices of simulation design (lecture note slides)"/> 
    width: 1150
    slide-number: true
    sc-sb-title: true
    incremental: true   
...
open-graph:
    description: "A high-level overview of the place of Monte Carlo simulations. Introduction to best practices of simulation design (lecture note slides)" 
---
...
- The fundamental theorem of PAC learning + finite VC dimension results for certain classifier classes [@Shalev-Shwartz2014UnderstandingMachineLearning]
...
- Synthetic data generation for training data augmentation (see [this link](https://www.nvidia.com/en-us/use-cases/synthetic-data/))
