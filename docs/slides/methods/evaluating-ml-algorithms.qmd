...
format:
  revealjs:
    include-in-header: 
      text: |
        <meta name="description" content="Learn how to evaluate machine learning algorithms using Monte Carlo; including an example on classification with class imbalance (lecture note slides)"/> 
    width: 1150
    slide-number: true
    sc-sb-title: true
    incremental: true   
...
open-graph:
    description: "Learn how to evaluate machine learning algorithms using Monte Carlo; including an example on classification with class imbalance (lecture note slides)" 
---
...
- @Shalev-Shwartz2014UnderstandingMachineLearning or @Mohri2018FoundationsMachineLearning
- [My undergraduate slides](https://vladislav-morozov.github.io/econometrics-2/) 

On practical implementations with common packages:

- @Geron2025HandsOnMachineLearning
...
- Correcting: lower precision (more false `1` labels), but much better at actually detecting true `1`s (higher recall)
